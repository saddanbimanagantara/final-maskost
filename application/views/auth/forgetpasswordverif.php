                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('auth/forgetpasswordverif?token=' . $_GET['token']); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="password" type="password" class="form-control" name="password" tabindex="1" value="<?= set_value('password') ?>" autofocus>
                                        <span class="text-danger">
                                            <?= form_error('password') ?>
                                        </span>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="passwordrepeat" type="password" class="form-control" name="passwordrepeat" tabindex="1" value="<?= set_value('passwordrepeat') ?>" autofocus>
                                        <span class="text-danger">
