...
<?php
if ($this->uri->segment(2) == "" || $this->uri->segment(2) == "index" || $this->uri->segment('2') === 'keuangan') { ?>
...
<?php
  ...
  <script src="<?php echo base_url(); ?>assets/modules/owlcarousel2/dist/owl.carousel.min.js"></script>
<?php
} elseif ($this->uri->segment(4) === "detail" || $this->uri->segment(4) === "add" || $this->uri->segment(3) === "detail" || $this->uri->segment(3) === 'kategori' || $this->uri->segment(3) === 'fasilitas' || $this->uri->segment(3) === 'administrator' || $this->uri->segment(5) === 'juragan' || $this->uri->segment(5) === 'penghuni' || $this->uri->segment(3) === 'transaksi' || $this->uri->segment(3) === 'add') { ?>
...
<?php
} elseif ($this->uri->segment(2) == "modules_sweet_alert"  || $this->uri->segment(3) === "detail") { ?>
