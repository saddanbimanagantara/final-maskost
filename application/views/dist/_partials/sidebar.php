  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="dropdown <?php echo $this->uri->segment(2) == 'user' || $this->uri->segment(2) == 'member' || $this->uri->segment(2) == 'member' ? 'active' : ''; ?>">
        ...
        <ul class="dropdown-menu">
          <li class="<?php echo $this->uri->segment(3) == 'administrator' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>admin/user/member/master/admin">Administrator</a></li>
      ...
      <li class="menu <?php echo $this->uri->segment(2) == 'profit' || $this->uri->segment(2) == 'profit' || $this->uri->segment(2) == 'profit' ? 'active' : ''; ?>"><a href="<?= base_url('admin/profit') ?>" class="nav-link"><i class="fa-solid fa-money-bills"></i><span>Profit</span></a></li>
