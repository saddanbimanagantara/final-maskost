...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <!-- <li class="menu <?php echo $this->uri->segment(3) == 'penghuni' ? 'active' : ''; ?>"><a href="<?= base_url('penghuni/chat') ?>" class="nav-link"><i class="fa-solid fa-comment-dots"></i><span>Chat</span></a></li> -->
