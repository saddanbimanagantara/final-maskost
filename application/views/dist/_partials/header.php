...
if ($this->uri->segment(2) == "layout_transparent") {
  ...
  if ($this->uri->segment(1) === "profile") {
    ...
    } else if ($user['otoritas'] === 'juragan') {
      $this->load->view('dist/_partials/sidebar_juragan');
    } else if ($user['otoritas'] === 'penghuni') {
      $this->load->view('dist/_partials/sidebar_penghuni');
    }
  } else if ($this->uri->segment(1) === 'admin') {
    $this->load->view('dist/_partials/sidebar');
  } else if ($this->uri->segment(1) === 'juragan') {
    $this->load->view('dist/_partials/sidebar_juragan');
  } else if ($this->uri->segment(1) === 'penghuni') {
    $this->load->view('dist/_partials/sidebar_penghuni');
  }
}
?>